    ...
    return _x2.clause(function(r /* resume-result<3463,3485> */ ) {
      if (r._tag === 1) {
        ...
        return prompt(w0_1_sq_, w1_1_sq_, ev, m, ret, _x2.cont(function() {
            return yield_to_final(m, function(_x_at___wildcard_x409__85 /* (resume-result<3463,3485>) -> 3483 3485 */ ) {
                return r.result;
              });
          }));
      }
...
export function finally_prompt(fin, res) /* forall<a,e> (fin : () -> e (), res : a) -> e a */  {
  ...
  if (b) {
    if ($std_core_hnd._yielding_non_final()) {
      ...
      fin();
      if ($std_core_hnd._yielding()) {
        return yield_extend(function(_x_at___wildcard_x490__43 /* _4375 */ ) {
    ...
    fin();
    if ($std_core_hnd._yielding()) {
      return yield_extend(function(_x_at___wildcard_x483__40 /* _4302 */ ) {
        return res;
      });
    }
    else {
    ...
    return yield_cont(function(cont /* (4636) -> 4650 4649 */ , x /* 4636 */ ) {
      ...
      if ((cnt == 0)) {
        ...
        if ($std_core_hnd._yielding()) {
          ...
          yield_extend(function(_x_at___wildcard_x531__35 /* _4583 */ ) {
...
export function initially(init, action) /* forall<a,e> (init : (int) -> e (), action : () -> e a) -> e a */  {
  ...
  init(0);
  if ($std_core_hnd._yielding()) {
    return yield_extend(function(_x_at___wildcard_x519__40 /* () */ ) {
...
export function clause_control_raw1(op) /* forall<a,b,e,e1,c,d> (op : (x : a, r : resume-context<b,e,e1,d>) -> e d) -> clause1<a,b,c,e,d> */  {
  return function(m /* marker<5686,5689> */ , _x_at___wildcard_x598__16 /* ev<5688> */ , x /* 5684 */ ) {
  ...
  if (did_resume) {
    ...
    if (b) {
      if ($std_core_hnd._yielding_non_final()) {
        ...
        k(Finalize(res));
        if ($std_core_hnd._yielding()) {
          return yield_extend(function(_x_at___wildcard_x621__43 /* _5892 */ ) {
            return unsafe_reyield(yld);
          });
        }
        else {
...
export function clause_control1(clause) /* forall<a,b,e,c,d> (clause : (x : a, k : (b) -> e d) -> e d) -> clause1<a,b,c,e,d> */  {
  return function(m /* marker<6150,6152> */ , _x_at___wildcard_x639__16 /* ev<6151> */ , x /* 6148 */ ) {
...
export function clause_tail1(op) /* forall<e,a,b,c,d> (op : (c) -> e d) -> clause1<c,d,b,e,a> */  {
  return function(_x_at___wildcard_x644__14 /* marker<6233,6234> */ , ev /* ev<6235> */ , x /* 6236 */ ) {
...
export function clause_tail_noop1(op) /* forall<e,a,b,c,d> (op : (c) -> e d) -> clause1<c,d,b,e,a> */  {
  return function(_x_at___wildcard_x649__14 /* marker<6304,6305> */ , _x_at___wildcard_x649__17 /* ev<6306> */ , x /* 6307 */ ) {
    return op(x);
  };
}
...
export function clause_never1(op) /* forall<a,b,e,c,d> (op : (a) -> e d) -> clause1<a,b,c,e,d> */  {
  return function(m /* marker<6393,6395> */ , _x_at___wildcard_x654__16 /* ev<6394> */ , x /* 6391 */ ) {
    return yield_to_final(m, function(_x_at___wildcard_x654__45 /* (resume-result<6392,6395>) -> 6393 6395 */ ) {
        return op(x);
      });
  };
}
...
export function clause_control_raw0(op) /* forall<a,e,e1,b,c> (op : (resume-context<a,e,e1,c>) -> e c) -> clause0<a,b,e,c> */  {
  return function(m /* marker<6804,6807> */ , _x_at___wildcard_x680__16 /* ev<6806> */ ) {
...
export function clause_control0(op) /* forall<a,e,b,c> (op : ((a) -> e c) -> e c) -> clause0<a,b,e,c> */  {
  return function(m /* marker<6897,6899> */ , _x_at___wildcard_x688__16 /* ev<6898> */ ) {
    return yield_to(m, function(k /* (resume-result<6896,6899>) -> 6897 6899 */ ) {
        return protect($std_core_types.Unit, function(_x_at___wildcard_x688__55 /* () */ , r /* (6896) -> 6897 6899 */ ) {
            return op(r);
          }, k);
      });
  };
...
export function clause_tail0(op) /* forall<e,a,b,c> (op : () -> e c) -> clause0<c,b,e,a> */  {
  return function(_x_at___wildcard_x692__14 /* marker<6965,6966> */ , ev /* ev<6967> */ ) {
...
export function clause_tail_noop0(op) /* forall<e,a,b,c> (op : () -> e c) -> clause0<c,b,e,a> */  {
  return function(_x_at___wildcard_x695__14 /* marker<7023,7024> */ , _x_at___wildcard_x695__17 /* ev<7025> */ ) {
    return op();
  };
}
 
export function clause_value(v) /* forall<a,e,b,c> (v : a) -> clause0<a,b,e,c> */  {
  return function(_x_at___wildcard_x698__14 /* marker<7081,7083> */ , _x_at___wildcard_x698__17 /* ev<7082> */ ) {
    return v;
  };
}
 
export function clause_never0(op) /* forall<a,e,b,c> (op : () -> e c) -> clause0<a,b,e,c> */  {
  return function(m /* marker<7155,7157> */ , _x_at___wildcard_x701__16 /* ev<7156> */ ) {
    return yield_to_final(m, function(_x_at___wildcard_x701__43 /* (resume-result<7154,7157>) -> 7155 7157 */ ) {
        return op();
      });
  };
}
...
export function clause_control2(clause) /* forall<a,b,c,e,d,a1> (clause : (x1 : a, x2 : b, k : (c) -> e a1) -> e a1) -> clause2<a,b,c,d,e,a1> */  {
  return function(m /* marker<7692,7694> */ , _x_at___wildcard_x726__16 /* ev<7693> */ , x1 /* 7689 */ , x2 /* 7690 */ ) {
...
export function clause_control_raw2(op) /* forall<a,b,c,e,e1,d,a1> (op : (x1 : a, x2 : b, r : resume-context<c,e,e1,a1>) -> e a1) -> clause2<a,b,c,d,e,a1> */  {
  return function(m /* marker<7811,7814> */ , _x_at___wildcard_x730__16 /* ev<7813> */ , x1 /* 7808 */ , x2 /* 7809 */ ) {
...
export function clause_tail_noop2(op) /* forall<e,a,b,c,d,a1> (op : (c, d) -> e a1) -> clause2<c,d,a1,b,e,a> */  {
  return function(_x_at___wildcard_x736__14 /* marker<7997,7998> */ , _x_at___wildcard_x736__17 /* ev<7999> */ , x1 /* 8000 */ , x2 /* 8001 */ ) {
    return op(x1, x2);
  };
}
...
export function clause_never2(op) /* forall<a,b,c,e,d,a1> (op : (a, b) -> e a1) -> clause2<a,b,c,d,e,a1> */  {
  return function(m /* marker<8221,8223> */ , _x_at___wildcard_x744__16 /* ev<8222> */ , x1 /* 8218 */ , x2 /* 8219 */ ) {
    return yield_to_final(m, function(_x_at___wildcard_x744__49 /* (resume-result<8220,8223>) -> 8221 8223 */ ) {
        return op(x1, x2);
      });
  };
}
...
export function clause_control_raw3(op) /* forall<a,b,c,d,e,e1,a1,b1> (op : (x1 : a, x2 : b, x3 : c, r : resume-context<d,e,e1,b1>) -> e b1) -> clause1<(a, b, c),d,a1,e,b1> */  {
  return function(m /* marker<8434,8437> */ , _x_at___wildcard_x598__16 /* ev<8436> */ , x /* (8430, 8431, 8432) */ ) {
...
export function clause_control3(op) /* forall<a,b,c,d,e,a1,b1> (op : (x1 : a, x2 : b, x3 : c, k : (d) -> e b1) -> e b1) -> clause1<(a, b, c),d,a1,e,b1> */  {
  return function(m /* marker<8540,8542> */ , _x_at___wildcard_x639__16 /* ev<8541> */ , x /* (8536, 8537, 8538) */ ) {
...
export function clause_tail_noop3(op) /* forall<e,a,b,c,d,a1,b1> (op : (c, d, a1) -> e b1) -> clause1<(c, d, a1),b1,b,e,a> */  {
  return function(_x_at___wildcard_x649__14 /* marker<8738,8739> */ , _x_at___wildcard_x649__17 /* ev<8740> */ , x /* (8741, 8742, 8743) */ ) {
    return op(x.fst, x.snd, x.thd);
  };
}
 
export function clause_never3(op) /* forall<a,b,c,d,e,a1,b1> (op : (a, b, c) -> e b1) -> clause1<(a, b, c),d,a1,e,b1> */  {
  return function(m /* marker<8843,8845> */ , _x_at___wildcard_x654__16 /* ev<8844> */ , x /* (8839, 8840, 8841) */ ) {
    return yield_to_final(m, function(_x_at___wildcard_x654__45 /* (resume-result<8842,8845>) -> 8843 8845 */ ) {
        return op(x.fst, x.snd, x.thd);
      });
  };
}
...
export function clause_control4(op) /* forall<a,b,c,d,a1,e,b1,c1> (op : (x1 : a, x2 : b, x3 : c, x4 : d, k : (a1) -> e c1) -> e c1) -> clause1<(a, b, c, d),a1,b1,e,c1> */  {
  return function(m /* marker<9187,9189> */ , _x_at___wildcard_x639__16 /* ev<9188> */ , x /* (9182, 9183, 9184, 9185) */ ) {
...
export function clause_tail_noop4(op) /* forall<e,a,b,c,d,a1,b1,c1> (op : (c, d, a1, b1) -> e c1) -> clause1<(c, d, a1, b1),c1,b,e,a> */  {
  return function(_x_at___wildcard_x649__14 /* marker<9408,9409> */ , _x_at___wildcard_x649__17 /* ev<9410> */ , x /* (9411, 9412, 9413, 9414) */ ) {
...
export function clause_never4(op) /* forall<a,b,c,d,a1,e,b1,c1> (op : (a, b, c, d) -> e c1) -> clause1<(a, b, c, d),a1,b1,e,c1> */  {
  return function(m /* marker<9526,9528> */ , _x_at___wildcard_x654__16 /* ev<9527> */ , x /* (9521, 9522, 9523, 9524) */ ) {
    return yield_to_final(m, function(_x_at___wildcard_x654__45 /* (resume-result<9525,9528>) -> 9526 9528 */ ) {
        return op(x.fst, x.snd, x.thd, x.field4);
      });
  };
}
