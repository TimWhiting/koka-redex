...
export function nearly_eq(x, y, epsilon) /* (x : float64, y : float64, epsilon : ? float64) -> bool */  {
  ...
  var _uniq_epsilon_1784 = (epsilon !== undefined) ? epsilon : ((8.0) * (2.220446049250313e-16));
  if ((x === y)) {
    return true;
  }
  else {
    ...
    if ((x === (0.0))) {
      return ((((2.0) * diff)) < ((_uniq_epsilon_1784 * (2.2250738585072014e-308))));
    }
    else {
      if ((y === (0.0))) {
        return ((((2.0) * diff)) < ((_uniq_epsilon_1784 * (2.2250738585072014e-308))));
        ...
        if ((diff < (2.2250738585072014e-308))) {
          ...
          return ((((((2.0) * diff)) / _x8)) < _uniq_epsilon_1784);
        }
      }
    }
  }
...
// monadic lift
export function _mlift_phexdouble_10186(wild___2) /* (wild_@2 : char) -> std/text/parse/parse int */  {
  return $std_text_parse.pint();
}
 
 
// monadic lift
export function _mlift_phexdouble_10187(frac, man, exp) /* (frac : string, man : string, exp : int) -> std/text/parse/parse float64 */  {
   
  var _x_x1_1_10174 = $std_core_hnd._open_none2($std_core_types._lp__plus__plus__rp_, man, frac);
   
  var _x_x1_0_10172 = $std_core_hnd._open_none2(function(s /* string */ , hex /* ? bool */ ) {
  ...
  var y_10163 = $std_core_types._int_mul(4,($std_core_hnd._open_none1($std_core_string.chars_fs_count, frac)));
   
  var e = $std_core_types._int_sub(exp,y_10163);
...
// monadic lift
export function _mlift_phexdouble_10188(wild___1) /* (wild_@1 : char) -> std/text/parse/parse string */  {
  return $std_text_parse.hex_digits();
}
 
 
// monadic lift
export function _mlift_phexdouble_10189(man, _y_x10133) /* (man : string, string) -> std/text/parse/parse float64 */  {
   
  var frac = $std_core_hnd._open_none2($std_core_sslice.trim_right, _y_x10133, "0");
   
  var x_10209 = $std_text_parse._lp__bar__bar__rp_(function() {
       
      var x_0_10211 = $std_text_parse.one_of("pP");
      if ($std_core_hnd._yielding()) {
        return $std_core_hnd.yield_extend(_mlift_phexdouble_10186);
      }
      else {
        return $std_text_parse.pint();
      }
  ...
  if ($std_core_hnd._yielding()) {
    return $std_core_hnd.yield_extend(function(exp /* int */ ) {
      return _mlift_phexdouble_10187(frac, man, exp);
    });
  }
  else {
    return _mlift_phexdouble_10187(frac, man, x_10209);
  }
}
 
 
// monadic lift
export function _mlift_phexdouble_10190(man) /* (man : string) -> std/text/parse/parse float64 */  {
   
  var x_10213 = $std_text_parse._lp__bar__bar__rp_(function() {
       
      var x_0_10215 = $std_text_parse.char(0x002E);
      if ($std_core_hnd._yielding()) {
        return $std_core_hnd.yield_extend(_mlift_phexdouble_10188);
      }
      else {
        return $std_text_parse.hex_digits();
      }
  ...
  if ($std_core_hnd._yielding()) {
    return $std_core_hnd.yield_extend(function(_y_x10133 /* string */ ) {
      return _mlift_phexdouble_10189(man, _y_x10133);
    });
  }
  else {
    return _mlift_phexdouble_10189(man, x_10213);
  }
}
 
 
// monadic lift
export function _mlift_phexdouble_10191(wild___0) /* (wild_@0 : char) -> std/text/parse/parse float64 */  {
   
  var x_10217 = $std_text_parse.hex_digits();
  if ($std_core_hnd._yielding()) {
    return $std_core_hnd.yield_extend(_mlift_phexdouble_10190);
  }
  else {
    return _mlift_phexdouble_10190(x_10217);
  }
}
 
 
// monadic lift
export function _mlift_phexdouble_10192(wild__) /* (wild_ : char) -> std/text/parse/parse float64 */  {
   
  var x_10219 = $std_text_parse.one_of("xX");
  if ($std_core_hnd._yielding()) {
    return $std_core_hnd.yield_extend(_mlift_phexdouble_10191);
  }
  else {
    return _mlift_phexdouble_10191(x_10219);
  }
}
 
export function phexdouble() /* () -> std/text/parse/parse float64 */  {
   
  var x_10221 = $std_text_parse.char(0x0030);
  if ($std_core_hnd._yielding()) {
    return $std_core_hnd.yield_extend(_mlift_phexdouble_10192);
  }
  else {
     
    var x_0_10224 = $std_text_parse.one_of("xX");
    if ($std_core_hnd._yielding()) {
      return $std_core_hnd.yield_extend(_mlift_phexdouble_10191);
    }
    else {
       
      var x_1_10227 = $std_text_parse.hex_digits();
      if ($std_core_hnd._yielding()) {
        return $std_core_hnd.yield_extend(_mlift_phexdouble_10190);
      }
      else {
         
        var x_2_10230 = $std_text_parse._lp__bar__bar__rp_(function() {
             
            var x_3_10233 = $std_text_parse.char(0x002E);
            if ($std_core_hnd._yielding()) {
              return $std_core_hnd.yield_extend(_mlift_phexdouble_10188);
            }
            else {
        ...
        if ($std_core_hnd._yielding()) {
          return $std_core_hnd.yield_extend(function(_y_x10133 /* string */ ) {
            return _mlift_phexdouble_10189(x_1_10227, _y_x10133);
          });
        }
        else {
           
          var frac = $std_core_hnd._open_none2($std_core_sslice.trim_right, x_2_10230, "0");
           
          var x_4_10235 = $std_text_parse._lp__bar__bar__rp_(function() {
               
              var x_5_10238 = $std_text_parse.one_of("pP");
              if ($std_core_hnd._yielding()) {
                return $std_core_hnd.yield_extend(_mlift_phexdouble_10186);
              }
              else {
          ...
          if ($std_core_hnd._yielding()) {
            return $std_core_hnd.yield_extend(function(exp /* int */ ) {
              return _mlift_phexdouble_10187(frac, x_1_10227, exp);
            });
          }
          else {
             
            var _x_x1_1_10174 = $std_core_hnd._open_none2($std_core_types._lp__plus__plus__rp_, x_1_10227, frac);
            ...
            var e = $std_core_types._int_sub(x_4_10235,y_10163);
...
// monadic lift
export function _mlift_pdecdouble_10193(wild___0) /* (wild_@0 : char) -> std/text/parse/parse int */  {
  return $std_text_parse.pint();
}
 
 
// monadic lift
export function _mlift_pdecdouble_10194(cur, exp) /* (cur : sslice/sslice, exp : int) -> std/text/parse/parse float64 */  {
   
  var _x_x1_1_10184 = $std_core_hnd._open_none1($std_core_sslice.string, cur);
  return $std_core_hnd._open_none1(prim_parse_float64, _x_x1_1_10184);
}
 
 
// monadic lift
export function _mlift_pdecdouble_10195(wild__) /* (wild_ : char) -> std/text/parse/parse string */  {
  return $std_text_parse.digits0();
}
 
 
// monadic lift
export function _mlift_pdecdouble_10196(cur, _y_x10141) /* (cur : sslice/sslice, string) -> std/text/parse/parse float64 */  {
   
  var frac = $std_core_hnd._open_none2($std_core_sslice.trim_right, _y_x10141, "0");
   
  var x_10240 = $std_text_parse._lp__bar__bar__rp_(function() {
       
      var x_0_10242 = $std_text_parse.one_of("eE");
      if ($std_core_hnd._yielding()) {
        return $std_core_hnd.yield_extend(_mlift_pdecdouble_10193);
      }
      else {
        return $std_text_parse.pint();
      }
  ...
  function next_10241(exp) /* (int) -> std/text/parse/parse float64 */  {
  ...
  if ($std_core_hnd._yielding()) {
    ...
    return next_10241(x_10240);
  }
}
 
 
// monadic lift
export function _mlift_pdecdouble_10197(cur, man) /* (cur : sslice/sslice, man : string) -> std/text/parse/parse float64 */  {
   
  var x_10246 = $std_text_parse._lp__bar__bar__rp_(function() {
       
      var x_0_10248 = $std_text_parse.char(0x002E);
      if ($std_core_hnd._yielding()) {
        return $std_core_hnd.yield_extend(_mlift_pdecdouble_10195);
      }
      else {
        return $std_text_parse.digits0();
      }
  ...
  if ($std_core_hnd._yielding()) {
    return $std_core_hnd.yield_extend(function(_y_x10141 /* string */ ) {
      return _mlift_pdecdouble_10196(cur, _y_x10141);
    });
  }
  else {
    return _mlift_pdecdouble_10196(cur, x_10246);
  }
}
 
 
// monadic lift
export function _mlift_pdecdouble_10198(cur) /* (cur : sslice/sslice) -> std/text/parse/parse float64 */  {
   
  var x_10250 = $std_text_parse.digits();
  if ($std_core_hnd._yielding()) {
    return $std_core_hnd.yield_extend(function(man /* string */ ) {
      return _mlift_pdecdouble_10197(cur, man);
    });
  }
  else {
    return _mlift_pdecdouble_10197(cur, x_10250);
  }
}
 
export function pdecdouble() /* () -> std/text/parse/parse float64 */  {
   
  var ev_10252 = $std_core_hnd._evv_at(($std_core_hnd._open_none1($std_core_types._make_ssize__t, 0)));
   
  var _x24 = $std_text_parse.current_input_fs__select(ev_10252.hnd);
  var x = _x24(ev_10252.marker, ev_10252);
  if ($std_core_hnd._yielding()) {
    return $std_core_hnd.yield_extend(_mlift_pdecdouble_10198);
  }
  else {
     
    var x_0_10254 = $std_text_parse.digits();
    if ($std_core_hnd._yielding()) {
      return $std_core_hnd.yield_extend(function(man /* string */ ) {
        return _mlift_pdecdouble_10197(x, man);
      });
    }
    else {
       
      var x_1_10257 = $std_text_parse._lp__bar__bar__rp_(function() {
           
          var x_2_10260 = $std_text_parse.char(0x002E);
          if ($std_core_hnd._yielding()) {
            return $std_core_hnd.yield_extend(_mlift_pdecdouble_10195);
          }
          else {
      ...
      if ($std_core_hnd._yielding()) {
        return $std_core_hnd.yield_extend(function(_y_x10141 /* string */ ) {
          return _mlift_pdecdouble_10196(x, _y_x10141);
        });
      }
      else {
         
        var frac = $std_core_hnd._open_none2($std_core_sslice.trim_right, x_1_10257, "0");
         
        var x_3_10262 = $std_text_parse._lp__bar__bar__rp_(function() {
             
            var x_4_10265 = $std_text_parse.one_of("eE");
            if ($std_core_hnd._yielding()) {
              return $std_core_hnd.yield_extend(_mlift_pdecdouble_10193);
            }
            else {
        ...
        if ($std_core_hnd._yielding()) {
          return $std_core_hnd.yield_extend(function(exp /* int */ ) {
            ...
            var _x_x1_1_10184 = $std_core_hnd._open_none1($std_core_sslice.string, x);
            return $std_core_hnd._open_none1(prim_parse_float64, _x_x1_1_10184);
          });
        }
        else {
           
          var _x_x1_1_10184_0 = $std_core_hnd._open_none1($std_core_sslice.string, x);
          return $std_core_hnd._open_none1(prim_parse_float64, _x_x1_1_10184_0);
        }
      }
    }
  }
...
// monadic lift
export function _mlift_pspecial_10199(wild__) /* (wild_ : string) -> std/text/parse/parse float64 */  {
  return nan;
}
 
 
// monadic lift
export function _mlift_pspecial_10200(wild___0) /* (wild_@0 : string) -> std/text/parse/parse float64 */  {
  return posinf;
}
 
 
// monadic lift
export function _mlift_pspecial_10201(wild___1) /* (wild_@1 : string) -> std/text/parse/parse float64 */  {
  return posinf;
}
...
export function pspecial() /* () -> std/text/parse/parse float64 */  {
  return $std_text_parse.choose($std_core_types.Cons(function() {
      ...
      var x_10269 = $std_text_parse.pstring("nan");
      if ($std_core_hnd._yielding()) {
        return $std_core_hnd.yield_extend(_mlift_pspecial_10199);
      }
      else {
        return nan;
      }
        ...
        var x_0_10271 = $std_text_parse.pstring("infinity");
        if ($std_core_hnd._yielding()) {
          return $std_core_hnd.yield_extend(_mlift_pspecial_10200);
        }
        else {
          return posinf;
        }
          ...
          var x_1_10273 = $std_text_parse.pstring("inf");
          if ($std_core_hnd._yielding()) {
            return $std_core_hnd.yield_extend(_mlift_pspecial_10201);
          }
          else {
            return posinf;
          }
...
// monadic lift
export function _mlift_pdouble_10202(wild__) /* (wild_ : string) -> std/text/parse/parse float64 */  {
  return nan;
}
 
 
// monadic lift
export function _mlift_pdouble_10203(wild___0) /* (wild_@0 : string) -> std/text/parse/parse float64 */  {
  return posinf;
}
 
 
// monadic lift
export function _mlift_pdouble_10204(wild___1) /* (wild_@1 : string) -> std/text/parse/parse float64 */  {
  return posinf;
}
 
 
// monadic lift
export function _mlift_pdouble_10205(neg, d) /* (neg : bool, d : float64) -> std/text/parse/parse float64 */  {
  return (neg) ? (-d) : d;
}
 
 
// monadic lift
export function _mlift_pdouble_10206(neg) /* (neg : bool) -> std/text/parse/parse float64 */  {
   
  var x_10275 = $std_text_parse.choose($std_core_types.Cons(phexdouble, $std_core_types.Cons(pdecdouble, $std_core_types.Cons(function() {
          return $std_text_parse.choose($std_core_types.Cons(function() {
               
              var x_0_10277 = $std_text_parse.pstring("nan");
              if ($std_core_hnd._yielding()) {
                return $std_core_hnd.yield_extend(_mlift_pdouble_10202);
              }
              else {
                return nan;
              }
                ...
                var x_1_10279 = $std_text_parse.pstring("infinity");
                if ($std_core_hnd._yielding()) {
                  return $std_core_hnd.yield_extend(_mlift_pdouble_10203);
                }
                else {
                  return posinf;
                }
                  ...
                  var x_2_10281 = $std_text_parse.pstring("inf");
                  if ($std_core_hnd._yielding()) {
                    return $std_core_hnd.yield_extend(_mlift_pdouble_10204);
                  }
                  else {
                    return posinf;
                  }
  ...
  function next_10276(d) /* (float64) -> std/text/parse/parse float64 */  {
    return (neg) ? (-d) : d;
  }
  if ($std_core_hnd._yielding()) {
    return $std_core_hnd.yield_extend(next_10276);
  }
  else {
    return next_10276(x_10275);
  }
}
...
export function pdouble() /* () -> std/text/parse/parse float64 */  {
  ...
  if ($std_core_hnd._yielding()) {
    return $std_core_hnd.yield_extend(_mlift_pdouble_10206);
  }
  else {
     
    var x_0_10288 = $std_text_parse.choose($std_core_types.Cons(phexdouble, $std_core_types.Cons(pdecdouble, $std_core_types.Cons(function() {
            return $std_text_parse.choose($std_core_types.Cons(function() {
                 
                var x_1_10291 = $std_text_parse.pstring("nan");
                if ($std_core_hnd._yielding()) {
                  return $std_core_hnd.yield_extend(_mlift_pdouble_10202);
                }
                else {
                  ...
                  var x_2_10293 = $std_text_parse.pstring("infinity");
                  if ($std_core_hnd._yielding()) {
                    return $std_core_hnd.yield_extend(_mlift_pdouble_10203);
                  }
                  else {
                    ...
                    var x_3_10295 = $std_text_parse.pstring("inf");
                    if ($std_core_hnd._yielding()) {
                      return $std_core_hnd.yield_extend(_mlift_pdouble_10204);
                    }
                    else {
    ...
    if ($std_core_hnd._yielding()) {
      ...
      return (x_10285) ? (-x_0_10288) : x_0_10288;
    }
  }
}
...
// monadic lift
export function _mlift_parse_float64_10207(x, wild__) /* (x : float64, wild_ : ()) -> std/text/parse/parse float64 */  {
  return x;
}
 
 
// monadic lift
export function _mlift_parse_float64_10208(x) /* (x : float64) -> std/text/parse/parse float64 */  {
   
  var x_0_10299 = $std_text_parse.eof();
  if ($std_core_hnd._yielding()) {
...
export function parse_float64(s) /* (s : string) -> maybe<float64> */  {
  ...
  var perr_10105 = $std_text_parse.parse(input_10106, function() {
      ...
      var x_10303 = pdouble();
      if ($std_core_hnd._yielding()) {
        return $std_core_hnd.yield_extend(_mlift_parse_float64_10208);
      }
      else {
        return _mlift_parse_float64_10208(x_10303);
      }
    });
