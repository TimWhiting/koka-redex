...
// monadic lift
export function range_fs__mlift_fold_int64_10104(end, f, start, x) /* forall<a,e> (end : int64, f : (int64, a) -> e a, start : int64, x : a) -> e a */  {
  return range_fs_fold_int64($std_core_hnd._open_none1(function(i /* int64 */ ) {
        return BigInt.asIntN(64,i + 1n);
      }, start), end, x, f);
}
...
export function range_fs_fold_int64(start_0, end_0, init, f_0) /* forall<a,e> (start : int64, end : int64, init : a, f : (int64, a) -> e a) -> e a */  { tailcall: while(1)
{
  if ((start_0 > end_0)) {
    ...
    var x_0_10106 = f_0(start_0, init);
    if ($std_core_hnd._yielding()) {
      return $std_core_hnd.yield_extend(function(x_1 /* 3766 */ ) {
        return range_fs__mlift_fold_int64_10104(end_0, f_0, start_0, x_1);
      });
    }
    else {
      {
        // tail call
        var _x28 = $std_core_hnd._open_none1(function(i_0 /* int64 */ ) {
            return BigInt.asIntN(64,i_0 + 1n);
          }, start_0);
        start_0 = _x28;
        init = x_0_10106;
        continue tailcall;
...
export function fold_int64(n, init, f) /* forall<a,e> (n : int64, init : a, f : (int64, a) -> e a) -> e a */  {
  return range_fs_fold_int64(zero, $std_core_hnd._open_none1(function(i /* int64 */ ) {
        return BigInt.asIntN(64,i - 1n);
      }, n), init, f);
}
...
// monadic lift
export function range_fs__mlift_lift_for_while64_4373_10105(action, end, i, _y_x10082) /* forall<a,e> (action : (int64) -> e maybe<a>, end : int64, i : int64, maybe<a>) -> e maybe<a> */  {
  if (_y_x10082 === null) {
     
    var i_0_10018 = $std_core_hnd._open_none1(function(i_1 /* int64 */ ) {
        return BigInt.asIntN(64,i_1 + 1n);
      }, i);
    return range_fs__lift_for_while64_4373(action, end, i_0_10018);
  }
  else {
...
export function range_fs__lift_for_while64_4373(action_0, end_0, i_0) /* forall<a,e> (action : (int64) -> e maybe<a>, end : int64, i : int64) -> e maybe<a> */  { tailcall: while(1)
{
  if ((i_0 <= end_0)) {
     
    var x_0_10109 = action_0(i_0);
    if ($std_core_hnd._yielding()) {
      return $std_core_hnd.yield_extend(function(_y_x10082_0 /* maybe<3877> */ ) {
        return range_fs__mlift_lift_for_while64_4373_10105(action_0, end_0, i_0, _y_x10082_0);
      });
    }
    else {
      if (x_0_10109 === null) {
         
        var i_0_10018_0 = $std_core_hnd._open_none1(function(i_1_0 /* int64 */ ) {
            return BigInt.asIntN(64,i_1_0 + 1n);
          }, i_0);
        {
          // tail call
          i_0 = i_0_10018_0;
        ...
        return $std_core_types.Just(x_0_10109.value);
      }
    }
  }
  else {
...
export function range_fs_for_while64(start, end, action) /* forall<a,e> (start : int64, end : int64, action : (int64) -> e maybe<a>) -> e maybe<a> */  {
  return range_fs__lift_for_while64_4373(action, end, start);
}
 
export function for_while64(n, action) /* forall<a,e> (n : int64, action : (int64) -> e maybe<a>) -> e maybe<a> */  {
   
  var end_10020 = $std_core_hnd._open_none1(function(i_0 /* int64 */ ) {
      return BigInt.asIntN(64,i_0 - 1n);
    }, n);
  return range_fs__lift_for_while64_4373(action, end_10020, zero);
}
